        ...
        <div class="login-content flex-row-fluid d-flex flex-column p-10">
            ...
            <div class="d-flex flex-row-fluid flex-center">
                ...
                <div class="login-form">
                    <!--begin::Form-->
                    <form class="form" id="kt_login_singin_form" action="{{route('login.postLogin')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <!--begin::Title-->
                        ...
                        <div class="form-group">
                            <label class="font-size-h6 font-weight-bolder text-dark">Your Email or Your Name</label>
                        ...
                        <div class="pb-lg-0 pb-5">
                            ...
                            <button type="button" class="btn btn-light-primary font-weight-bolder px-8 py-4 my-3 font-size-lg">
									<span class="svg-icon svg-icon-md">
										<!--begin::Svg Icon | path:{{asset('Login-layout')}}/media/svg/social-icons/google.svg-->
