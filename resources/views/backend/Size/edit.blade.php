    ...
    <div class="row">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Edits Colors</h4>
            </div>
            <div class="card-content" style="padding: 20px;">
                <div class="container">
                    <form action="{{route('sizes.update',$data->id)}}" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="name" class="form-control"
                                           ...
                                           maxlength="255"
                                           data-validation-maxlength-message="Tên size không quá 255 ký tự !"
                                           value="{{$data->name}}">
                                </div>
                                @error('name')
                                                ...
                                                <fieldset>
                                                    <div class="radio radio-primary radio-glow">
                                                        <input type="radio" id="radioGlow1"
                                                               ...
                                                               name="status" value="1"
                                                               @if($data->status== config('common.sizes.Active')) checked @endif
                                                        >
                                                ...
                                                <fieldset>
                                                    <div class="radio radio-danger radio-glow">
                                                        <input type="radio"
                                                               ...
                                                               data-validation-required-message="Trạng thái không được để trống !"
                                                               value="0"
                                                               @if($data->status== config('common.sizes.Inactive')) checked
                                                               @endif
                                                               id="radioGlow6">
                        ...
                        <div class="row pull-right" style="margin-top: 50px">
                            <div class="form-group ml-5" style="padding-left: calc(var(--bs-gutter-x) * 36.11);">
                                ...
                                <a href="{{route('sizes.index')}}" class="btn btn-primary">Quay Lại</a>
                            </div>
                        </div>
                    </form>
                </div>
