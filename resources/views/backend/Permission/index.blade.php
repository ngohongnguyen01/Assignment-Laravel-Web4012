    ...
    <div class="content-header row">
        <div class="content-header-left col-12 mb-2 mt-1">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h5 class="content-header-title float-left pr-1 mb-0">Permissions Tables</h5>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered mb-0">
                                ...
                                <tr>
                                    ...
                                    <th>Key Code</th>
                                    <th>ACTION</th>
                                    <th><a href="{{route('permission.create')}}" class="btn btn-primary pull-left">Add</a>
                                    </th>
                                </tr>
                                </thead>
                                <tbody>
                                @foreach ($data as $key => $value)
                                    <tr id='colum-{{$value->id}}'>
                                        ...
                                        <td>
                                            <a href="{{route('permission.edit',$value->id)}}" style="margin-left: -10px"
                                            ...
                                            <a class="btn btn-icon btn-danger rounded-circle" href="#" id='deleteWeb'
                                               data-value='{{$value->id}}' data-url="{{route('permission.destroy',$value->id)}}" style="margin-left:-10px;color:white">
                                                <i class="bx bx-x"></i>
                                            </a>
                                        </td>
