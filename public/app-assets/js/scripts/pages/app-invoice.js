    ...
    switch (selectOption) {
      ...
      case "Robust Admin Template":
        $(e.target)
          ...
          .find(".invoice-item-desc")
          .val(
            "Robust admin_assets is super flexible, powerful, clean & modern responsive bootstrap admin_assets template with unlimited possibilities"
          );
        break;
      case "Apex Admin Template":
        $(e.target)
          .closest(".invoice-item-filed")
          .find(".invoice-item-desc")
          .val("Developer friendly and highly customizable Angular 7+ jQuery Free Bootstrap 4 gradient ui admin_assets template. ");
        break;
      case "Modern Admin Template":
        $(e.target)
          .closest(".invoice-item-filed")
          .find(".invoice-item-desc")
          .val("The most complete & feature packed bootstrap 4 admin_assets template of 2019!");
        break;
    }
  });
  // print button
